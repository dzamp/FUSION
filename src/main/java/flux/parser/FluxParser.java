    ...
    private static TopologyDef processIncludes(Yaml yaml, TopologyDef topologyDef, Properties properties, boolean envSub)
        ...
        if (topologyDef.getIncludes() != null) {
            for (IncludeDef include : topologyDef.getIncludes()) {
                ...
                if (includeTopologyDef.getMqttconfig() != null) {
                    topologyDef.addAllMqttConfigs(includeTopologyDef.getMqttconfig(), override);
                }
                if (includeTopologyDef.getKafkaconfig() != null) {
                    topologyDef.addAllKafkaConfigs(includeTopologyDef.getKafkaconfig(), override);
                }
